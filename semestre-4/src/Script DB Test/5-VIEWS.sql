...
CONVERT_ENUM_REFEICAO_STR(ra.DiaDaSemana) AS "DiaDaSemana"
FROM DietaJa_test.RegistroDeAtividade AS ra
...
INNER JOIN DietaJa_test.Usuario AS usr ON ra.ID_Usuario = usr.ID_Usuario;
...
FROM DietaJa_test.Usuario tab1
ORDER BY Nome;
