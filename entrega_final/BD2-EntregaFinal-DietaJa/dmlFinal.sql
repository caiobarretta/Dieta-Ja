...
INSERT INTO DietaJa.PorcaoDeAlimento (Nome, Descricao, Ativo) 
VALUES ("Pão Integral", "Consumir 2 fatias - torradas", true);

INSERT INTO DietaJa.PorcaoDeAlimento (Nome, Descricao, Ativo) 
VALUES ("Queijo", "Queijos de baixa caloria (minal frescal)", true);

INSERT INTO DietaJa.PorcaoDeAlimento (Nome, Descricao, Ativo) 
VALUES ("Iorgute Natural", "Consumir copo de até 180ml/porção", true);

INSERT INTO DietaJa.PorcaoDeAlimento (Nome, Descricao, Ativo) 
VALUES ("Oleaginosas", "Nuts - castanha do pará, amêndoas", true);

INSERT INTO DietaJa.PorcaoDeAlimento (Nome, Descricao, Ativo) 
VALUES ("Ovos", "Consumir 1 por dia (mexidos, fritos, omelete)", true);

INSERT INTO DietaJa.PorcaoDeAlimento (Nome, Descricao, Ativo) 
VALUES ("Legumes e verduras", "Abobrinha, chuchu, espinafre, couve-flor", true);

INSERT INTO DietaJa.PorcaoDeAlimento (Nome, Descricao, Ativo) 
VALUES ("Quinoa Integral", "Consumir 100G quinoa integral ou arroz integral", true);
...
INSERT INTO DietaJa.PorcaoDeAlimentoDieta (ID_PorcaoAlimento, ID_Dieta) VALUES (1, 1);
INSERT INTO DietaJa.PorcaoDeAlimentoDieta (ID_PorcaoAlimento, ID_Dieta) VALUES (4, 1);
INSERT INTO DietaJa.PorcaoDeAlimentoDieta (ID_PorcaoAlimento, ID_Dieta)  VALUES (5, 1);
